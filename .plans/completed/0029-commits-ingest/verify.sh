...
echo "==> go test focused (commits, prconvo, prs, github)"
go test ./internal/ingest/commits/... ./internal/ingest/prconvo/... ./internal/ingest/prs/... ./internal/github/... -race -count=1
